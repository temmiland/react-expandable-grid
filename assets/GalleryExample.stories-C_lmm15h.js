...
/>
`}}}},l={args:{size:250,elements:15,fbJustifyContent:`space-between`}},u=[`Standard`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    size: 250,
    elements: 15,
