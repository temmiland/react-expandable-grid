import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-Q1GcV6wX.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";function i(){let e=(0,a.useRef)(null),[t,n]=(0,a.useState)(0);return(0,a.useEffect)(()=>{let t=e.current;if(!t)return;let r=()=>{n(t.clientWidth)};return window.addEventListener(`resize`,r),r(),()=>window.removeEventListener(`resize`,r)},[]),[t,e]}var a;function o(){return(o=t((()=>{a=n()})))()}var s,c,l;function u(){return(u=t((()=>{s=e(n(),1),o(),c=r(),l=({elements:e,expandableElementWidthInPx:t,fbJustifyContent:n=`space-between`,defaultSelectedIndex:r=void 0})=>{let[a,o]=i(),[l,u]=(0,s.useState)(r+1),d=Math.floor(a/t),f=Math.ceil(e.length/d);l!==void 0&&l>e.length&&u(1);let p=e=>{u(l===e?void 0:e)},m=t=>{let n=e[t-1].expandableElement;return(0,c.jsx)(`div`,{className:`expandable expandable-`+t,role:`button`,tabIndex:0,onClick:()=>p(t),onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),p(t))},children:(0,c.jsx)(n,{currentIndex:t})},`expandable-`+t)},h=t=>{let n=e[t-1].expandedElement;return(0,c.jsx)(`div`,{className:`expanded expanded-`+t,style:{display:l?`block`:`none`,width:`100%`},children:(0,c.jsx)(`div`,{children:(0,c.jsx)(n,{currentIndex:l,close:()=>p(void 0)})},`expanded-`+t)})};return(0,c.jsx)(`div`,{className:`expandable-grid`,ref:o,style:{display:`flex`,flexWrap:`wrap`,justifyContent:n},children:e.map((t,n)=>{let r=n+1===e.length,i=Math.ceil(l/d);return d*i===n+1||i===f&&r?(0,c.jsxs)(s.Fragment,{children:[m(n+1),h(n+1)]},`grid-item-`+(n+1)):m(n+1)})})},l.__docgenInfo={description:`A grid component that renders a collection of expandable elements.
