...
export function applyToTypeProperties(documentation, path, callback, typeParams, visited = new WeakSet()) {
    ...
    if (path.isObjectTypeAnnotation()) {
        ...
        path.get('types').forEach((typesPath) => applyToTypeProperties(documentation, typesPath, callback, typeParams, visited));
    }
        ...
        if (typePath) {
            applyToTypeProperties(documentation, typePath, callback, typeParams, visited);
        }
    }
}
function applyExtends(documentation, path, callback, typeParams, visited) {
    ...
    classExtends.forEach((extendsPath) => {
        ...
        if (resolvedPath) {
            ...
            applyToTypeProperties(documentation, resolvedPath, callback, typeParams, visited);
        }
        else {
