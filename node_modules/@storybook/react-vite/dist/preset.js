import CJS_COMPAT_NODE_URL_3vy05ymqtl4 from 'node:url';
import CJS_COMPAT_NODE_PATH_3vy05ymqtl4 from 'node:path';
import CJS_COMPAT_NODE_MODULE_3vy05ymqtl4 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_3vy05ymqtl4.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_3vy05ymqtl4.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_3vy05ymqtl4.createRequire(import.meta.url);
...
var core = {
  ...
  if (reactDocgenOption === "react-docgen-typescript" && typescriptPresent && plugins.push(
    ...
    let { reactDocgen } = await import("./_node-chunks/react-docgen-FMZKWQU3.js");
    plugins.unshift(
