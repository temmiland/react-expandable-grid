import CJS_COMPAT_NODE_URL_jd5k02mvel from 'node:url';
import CJS_COMPAT_NODE_PATH_jd5k02mvel from 'node:path';
import CJS_COMPAT_NODE_MODULE_jd5k02mvel from "node:module";

var __filename = CJS_COMPAT_NODE_URL_jd5k02mvel.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_jd5k02mvel.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_jd5k02mvel.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-LC5Y67H7.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-CTBINBGS.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-ER63YZJI.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-CWKMADKL.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
