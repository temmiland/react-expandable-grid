...
import {
  compile
} from "./chunk-BT2I4O4A.js";
import "./chunk-GSLJBUGU.js";
import "./chunk-V67HDMHN.js";
import {
  __commonJS,
  __toESM
} from "./chunk-LC5Y67H7.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-CTBINBGS.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-ER63YZJI.js")).default;
  return {
