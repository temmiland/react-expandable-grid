...
import {
  compile
} from "./chunk-DMPAMV7B.js";
import "./chunk-G42BAPG5.js";
import "./chunk-TFOXXSVU.js";
import {
  __commonJS,
  __toESM
} from "./chunk-2ZYOPMW6.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-VQBJLUQ6.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-FKYL2JPG.js")).default;
  return {
