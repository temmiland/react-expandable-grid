...
import { isAbsolute, posix, resolve as resolve$1, dirname, normalize, sep, relative, basename, extname } from 'node:path';
import { existsSync, readdirSync, lstatSync, rmdirSync } from 'node:fs';
import require$$0, { createRequire } from 'node:module';
import globToRegExp from 'glob-to-regexp';
import { yellow, green, cyan } from 'kolorist';
        ...
        if (!getHasExtractor()) {
          ...
          const bundleEntry = async (path) => {
            ...
            const danglingSpecifiers = collectRelativeModuleSpecifiers(bundledContent).filter(
              (specifier) => bundleResolution.resolve(path, specifier) !== void 0 || declarationModuleExtensions.has(extname(specifier))
            );
...
export { ensureAbsolute as a, editSourceMapDir as e, normalizePath as n, pluginFactory as p, resolve as r, slash as s, ts as t };
