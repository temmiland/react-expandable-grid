import { StoryId as StoryId$1, StoryName, ComponentTitle, Tag as Tag$2, Parameters, StrictArgTypes, Args, ArgTypes, ComponentId, StoryKind, Globals as Globals$1, GlobalTypes as GlobalTypes$1, InputType, Renderer, StoryContext, PartialStoryFn, LegacyStoryFn, ArgsStoryFn, StoryFn, DecoratorFunction, LoaderFunction as LoaderFunction$1, ViewMode as ViewMode$1, StoryIdentifier, ProjectAnnotations as ProjectAnnotations$1, StepRunner, BeforeAll, ComponentAnnotations, StoryAnnotations, StoryContextForEnhancers, CleanupCallback, Canvas, StoryAnnotationsOrFn, AnnotatedStoryFn } from 'storybook/internal/csf';
 ...
 */
type DocgenProvider = (input: DocgenProviderInput) => Promise<DocgenPayload | undefined>;
/**
...
interface StorybookConfig {
     ...
     */
    experimental_storyDocsProvider?: PresetValue<StorybookConfigRaw['experimental_storyDocsProvider']>;
}
 ...
 */
type StoryDocsProviderPreset = (nextStoryDocs: StoryDocsProvider, options: Options) => StoryDocsProvider | Promise<StoryDocsProvider>;
 ...
 */
type API_RefStoryRuntimeData = Record<StoryId$1, Partial<Pick<API_StoryEntry, 'prepared' | 'parameters' | 'args' | 'argTypes' | 'initialArgs'>>>;
...
type API_ViewMode = OrString$1<'story' | 'docs' | 'settings' | 'review'> | undefined;
...
type API_ComposedRefUpdate = Partial<Pick<API_ComposedRef, 'title' | 'type' | 'expanded' | 'index' | 'filteredIndex' | 'versions' | 'loginUrl' | 'version' | 'indexError' | 'previewInitialized' | 'sourceUrl' | 'internal_index' | 'storyUpdates'>>;
