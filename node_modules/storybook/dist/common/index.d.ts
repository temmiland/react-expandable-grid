...
import { CLIOptions, LoadOptions, BuilderOptions, StorybookConfigRaw, PresetConfig, CoreCommon_ResolvedAddonPreset, CoreCommon_ResolvedAddonVirtual, LoadedPreset, Presets, CoreCommon_AddonInfo, SupportedFramework, SupportedRenderer, SupportedBuilder, Options as Options$2, CoreWebpackCompiler, CoreCommon_StorybookInfo, Ref, StorybookConfig, StoriesEntry, NormalizedStoriesSpecifier, PackageJson, IndexEntry as IndexEntry$1, NormalizedProjectAnnotations, ProjectAnnotations, ComposedStoryFn } from 'storybook/internal/types';
...
import { StoryId, StoryName, ComponentTitle, Tag } from 'storybook/internal/csf';
...
declare const getStorybookInfo: (configDir?: string, cwd?: string, { skipCache }?: {
    skipCache?: boolean;
 ...
 *   Never throws.
 */
declare const readDependencyManifest: (directory: string, dependency: string) => Promise<PackageJson | undefined>;
...
*/
type Result<OptionsType extends Options = Options> = SuccessResult$1<false, OptionsType>;
 ...
 */
declare function getComponentIdFromEntry(entry: Pick<IndexEntry$1, 'id'>): string;
 ...
 */
declare function getStoryImportPathFromEntry(entry: IndexEntry): string | undefined;
/**
 ...
 */
declare function selectComponentEntriesByComponentId(indexEntries: IndexEntry[]): Map<string, IndexEntry>;
