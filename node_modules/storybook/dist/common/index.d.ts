import { Us as DocgenMiddleware, Ws as DocgenPayload$1, qs as DocgenProviderInput, tc as IndexEntry$1 } from "../chunk-zQu03vfn.js";
import { _ as ChannelLike } from "../chunk-OG_iMtt8.js";
import { n as registerService } from "../chunk-C7SCAuvd.js";
...
import { ConfigFile, CsfFile } from "storybook/internal/csf-tools";
...
declare const _default: {
  ...
  '@storybook/mcp': string;
  '@storybook/react-dom-shim': string;
  'vite-plugin-storybook-nextjs': string;
...
//#endregion
//#region code/core/.dts-emit/code/core/src/shared/constants/extensions.d.ts
/**
 ...
 */
declare const jsTsSourceExtensions: readonly ['.ts', '.tsx', '.js', '.jsx', '.mjs', '.cjs'];
//#endregion
...
//#endregion
//#region code/core/.dts-emit/code/core/src/common/utils/find-storybook-package-root.d.ts
/**
 ...
 */
declare function findStorybookPackageRoot(): string | undefined;
//#endregion
...
//#endregion
//#region code/core/.dts-emit/code/core/src/common/utils/module-resolver.d.ts
/**
 ...
 */
declare const defaultResolveConditionNames: string[];
declare function createModuleResolver(options?: ModuleResolverOptions): ModuleResolver;
//#endregion
...
//#endregion
//#region code/core/.dts-emit/code/core/src/common/utils/resolve-meta-component.d.ts
/** The component a story file documents, as far as static analysis can determine. */
interface ResolvedMetaComponent {
...
type MetaComponentResolution = {
  component: ResolvedMetaComponent;
} | {
  reason: 'no-meta-component' | 'no-component-import';
} | {
  reason: 'unreadable-component-expression'; /** Source text of the expression, so a caller can name what it could not follow. */
  expression: string;
};
interface MetaComponentResolverOptions {
 ...
 */
declare function createMetaComponentResolver(options?: MetaComponentResolverOptions): (csf: CsfFile, storyPath: string) => MetaComponentResolution;
//#endregion
...
declare const getTsconfigPathsBaseDir: (configPath: string) => string;
//#endregion
...
//#endregion
//#region code/core/.dts-emit/code/core/src/common/utils/lazy-docgen-middleware.d.ts
interface LazyDocgenMiddlewareOptions<TManager> {
  /**
   ...
   */
  extract: (manager: TManager, input: DocgenProviderInput) => Promise<DocgenPayload$1 | undefined>;
}
declare function createLazyDocgenMiddleware<TManager>({
  createManager,
  extract
...
//#endregion
//#region code/core/.dts-emit/code/core/src/shared/utils/paths.d.ts
/**
...
declare function isInNodeModules(path: string): boolean;
//#endregion
...
//#endregion
//#region code/core/.dts-emit/code/core/src/common/utils/file-lock.d.ts
 ...
 */
declare const withFileLock: (lockPath: string, run: () => Promise<void>, {
  waitBudgetMs,
  staleAfterMs
}?: FileLockOptions) => Promise<'ran' | 'busy'>;
//#endregion
...
//#endregion
export { DEFAULT_FILES_PATTERN, ExecuteCommandOptions, FileLockOptions, FileOptions, FileSystemCache, HandledError, InstallationMetadata, InterPresetOptions, JsPackageManager, JsPackageManagerFactory, LazyDocgenMiddlewareOptions, MIN_SUPPORTED_NODE_DESCRIPTION, MIN_SUPPORTED_NODE_VERSIONS, MetaComponentResolution, MetaComponentResolverOptions, MinNodeVersion, ModuleResolver, ModuleResolverOptions, type PackageJson, PackageJsonInfo, PackageJsonWithDepsAndDevDeps, PackageJsonWithMaybeDeps, PackageManagerName, PackageMetadata, RemoveAddonOptions, ResolveImportOptions, ResolvedMetaComponent, STORYBOOK_PACKAGE_PATTERNS, STORY_FILE_TEST_REGEXP, SetupAddonInConfigOptions, StorybookInstallContext, builderPackages, cache, checkAddonOrder, checkRef, clearVitePlusCache, commonGlobOptions, compilerPackages, createFileSystemCache, createLazyDocgenMiddleware, createLogStream, createMetaComponentResolver, createModuleResolver, defaultResolveConditionNames, doesVariableOrFunctionDeclarationExist, executeCommand, executeCommandSync, executeNodeCommand, extractFrameworkPackageName, extractRenderer, filterPresetsConfig, findConfigFile, findFilesUp, findStorybookPackageRoot, findTsconfigPath, findTsconfigPathForFile, findTsconfigPathForPath, formatFileContent, formatMinVersion, frameworkPackages, frameworkToBuilder, frameworkToRenderer, getAbsolutePathWrapperAsCallExpression, getAbsolutePathWrapperName, getAddonNames, getAgeInMinutes, getAutoRefs, getBabelPresetEnvMajor, getBuilderOptions, getComponentIdFromEntry, getConfigInfo, getDirectoryFromWorkingDir, getEnvConfig, getErrorLogs, getFieldsForGetAbsolutePathWrapper, getFrameworkName, getInterpretedFile, getLatestStableVersionAdheringToMinimumAgeGate, getMswInitCommand, getPackageDetails, getPresets, getPrettier, getPrettyPackageManagerName, getPreviewBodyTemplate, getPreviewHeadTemplate, getProjectRoot, getRefs, getRemotePackageRunnerArgs, getRendererName, getStoryId, getStoryImportPathFromEntry, getStoryTitle, getStorybookConfiguration, getStorybookInfo, getStorybookRerunCommand, getStorybookRerunInstruction, getTsconfigPathsBaseDir, getVitePlusVersions, getVitestStorybookRunCommand, globToRegexp, groupBy, hasStorybookMinimumAgeExclusions, importMetaResolve, importModule, interpolate, invalidateProjectRootCache, invariant, isCI, isCorePackage, isGetAbsolutePathWrapperNecessary, isInNodeModules, isNodeVersionSupported, isPreservingSymlinks, isSatelliteAddon, isWebContainer, jsTsSourceExtensions, loadAllPresets, loadEnvs, loadMainConfig, loadManagerOrAddonsFile, loadPreset, loadPreviewOrConfigFile, logConfig, nodePathsToArray, normalizeAddonName, normalizeStories, normalizeStoriesEntry, normalizeStoryPath, optionalEnvToBoolean, parseList, parsePackageData, parsePackageTimeMap, parsePositiveIntegerConfigValue, parseReleaseTime, posix, readDependencyManifest, readTemplate, registerService, removeAddon, rendererPackages, resolveAddonName, resolveImport, resolvePackageDir, resolvePathInStorybookCache, safeResolveModule, satisfies, scanAndTransformFiles, selectComponentEntriesByComponentId, serverRequire, setupAddonInConfig, slash, stringifyEnvs, stringifyProcessEnvs, supportedExtensions, syncPreviewAddonsWithMainConfig, syncStorybookAddons, temporaryDirectory, temporaryFile, transformImportFiles, validateConfigurationFiles, validateFrameworkName, _default as versions, withFileLock, wrapValueWithGetAbsolutePathWrapper };