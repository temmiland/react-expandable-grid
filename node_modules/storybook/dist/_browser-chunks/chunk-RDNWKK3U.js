...
var isLiteral2 = (type) => type.name === "literal", isUndefined = (type) => type.name === "undefined", isNull = (type) => type.name === "null", convertSig2 = (type) => {
  switch (type.type) {
    case "function":
      return { name: "function" };
    case "object":
  ...
  switch (typeof raw < "u" && (base.raw = raw), type.name) {
    ...
    case "union": {
      ...
      return nonUndefinedElements.some(isLiteral2) && nonUndefinedElements.every((element) => isLiteral2(element) || isNull(element)) ? {
        ...base,
        name: "enum",
        value: nonUndefinedElements.map(
          (element) => isLiteral2(element) ? parseLiteral(element.value) : null
        )
      } : { ...base, name, value: type.elements.map(convert3) };
    }
    case "intersection":
...
var ADDON_ID = "storybook/docs", PANEL_ID = `${ADDON_ID}/panel`, PARAM_KEY = "docs", anchorBlockIdFromId = (storyId) => `anchor--${storyId}`, SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`, SourceType = /* @__PURE__ */ ((SourceType2) => (SourceType2.AUTO = "auto", SourceType2.CODE = "code", SourceType2.DYNAMIC = "dynamic", SourceType2))(SourceType || {});
