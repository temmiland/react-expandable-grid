...
var activeSpinner = null, activeTaskLog = null, originalConsoleLog = null;
if (typeof process.stdout.columns == "number" && !(process.stdout.columns > 0))
  try {
    process.stdout.columns = getTerminalWidth();
  } catch {
  }
var isInteractiveTerminal = () => process.stdout.isTTY && process.stdin.isTTY && !process.env.CI, patchConsoleLog = () => {
