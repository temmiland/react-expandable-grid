...
import {
  getTypeImportSource
} from "./chunk-EXUHNYQA.js";
import {
  getDocsMarkdownUrl
} from "./chunk-LXJZZZ2P.js";
import {
  require_dist
...
function instructions(projectInfo) {
  let configDir = projectInfo.configDir, typeImport = getTypeImportSource(projectInfo), mswInit = getMswInitCommand(projectInfo.packageManager), vitestRunFile = getVitestStorybookRunCommand(
