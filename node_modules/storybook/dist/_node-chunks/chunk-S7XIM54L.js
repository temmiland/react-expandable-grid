...
// src/cli/tools/config-dir.ts
import { isAbsolute, resolve } from "node:path";
function resolveStorybookConfigDir({
  cwd,
  configDir
} = {}) {
  let projectCwd = resolve(cwd ?? process.cwd());
  return configDir ? isAbsolute(configDir) ? configDir : resolve(projectCwd, configDir) : resolve(projectCwd, ".storybook");
}
