...
}, OpenServiceMissingOriginError = class extends StorybookError {
  constructor(data) {
    super({
...
function describeUnknownStoryIds(unknownIds) {
  let plural = unknownIds.length === 1 ? "ID is" : "IDs are";
...
var OpenServiceUnknownStoryIdsError = class extends StorybookError {
  constructor(data) {
    let list = data.unknownIds.map((id) => `- ${id}`).join(`
`);
    super({
...
}, OpenServiceTestRunTimeoutError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceServicesAppliedTwiceError = class extends StorybookError {
  constructor() {
    super({
      name: "OpenServiceServicesAppliedTwiceError",
      category: "CORE-COMMON" /* CORE_COMMON */,
      code: 22,
      message: import_ts_dedent.dedent`The "services" preset property was applied twice, but should only be applied once.
        Multiple code paths applying it will cause service and toolset registration to fail.`
    });
  }
}, OpenServiceMissingToolsetError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceModuleGraphUnavailableError = class extends StorybookError {
  constructor(data) {
    super({
...
}, OpenServiceToolsetOutputMismatchError = class extends StorybookError {
  constructor(data) {
    let serialized;
    try {
      serialized = JSON.stringify(data.issues)?.slice(0, 2e3) ?? String(data.issues);
    } catch {
...
}, OpenServiceInvalidToolsetMethodIdError = class extends StorybookError {
  constructor(data) {
    super({
...
}, AngularUnresolvedStyleError = class extends StorybookError {
  constructor(data) {
    super({
...
}, AngularMissingStylePreprocessorError = class extends StorybookError {
  constructor(data) {
    super({
...
}, StorybookDevServerDisconnectedError = class extends StorybookError {
  constructor(data = {}) {
    super({
...
function formatExecaCommand(data) {
  return [data.command, ...data.args].join(" ");
}
function formatExecaFailureDetails(data) {
  let trimmedLogs = data.logs.trim();
  return trimmedLogs || (data.exitCode != null ? `Process exited with code ${data.exitCode}` : data.signal ? `Process was killed with signal ${data.signal}` : "No additional output was captured.");
}
function createExecaCommandFailedMessage(data) {
  return import_ts_dedent.dedent`
    Command failed: ${formatExecaCommand(data)}

    ${formatExecaFailureDetails(data)}`;
}
var ExecaCommandFailedError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PackageInstallFailedError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PackageInstallDependencyConflictError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PackageInstallMissingManifestError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PnpmIgnoredBuildsError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PnpmNoTtyModulesDirError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PackageManagerBinaryNotFoundError = class extends StorybookError {
  constructor(data) {
    super({
...
}, PlaywrightInstallFailedError = class extends StorybookError {
  constructor(data) {
    super({
...
}, NuxtModuleAddFailedError = class extends StorybookError {
  constructor(data) {
    super({
...
}, AutomigrateAddonA11yTestError = class extends StorybookError {
  constructor(data) {
    super({
