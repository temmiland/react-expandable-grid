...
var require_build = __commonJS({
  "../../node_modules/sirv/build.js"(exports, module) {
    var fs = __require("fs"), { join, normalize, resolve } = __require("path"), { totalist } = require_sync(), { parse: parse3 } = (init_build(), __toCommonJS(build_exports)), { lookup } = require_mrmime(), noop = () => {
    };
    ...
    module.exports = function(dir, opts = {}) {
      ...
      return function(req, res, next) {
        let extns = [""], pathname = parse3(req).pathname, val = req.headers["accept-encoding"] || "";
