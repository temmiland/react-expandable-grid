import { As as SupportedRenderer$1, Ms as SupportedBuilder$1, Ss as StorybookConfigRaw$1, al as Settings, js as SupportedFramework$1, ol as _clearGlobalSettings, sl as globalSettings } from "../chunk-zQu03vfn.js";
...
declare const ANALOG_VITE_PLUGIN_ANGULAR_VERSION = "^2.5.2";
declare const toDevkitVersion: (ngRange?: string | null) => string | undefined;
 ...
 */
declare const isStorybookTarget: (target: unknown, builderPackage?: string) => target is StorybookBuilderTarget;
