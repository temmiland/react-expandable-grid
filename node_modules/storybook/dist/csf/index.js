...
import {
  ...
  toId,
  toTestId
} from "../_browser-chunks/chunk-NULBREPZ.js";
import {
  composeConfigs,
  composeStory,
  mountDestructured,
  ...
  registerService
} from "../_browser-chunks/chunk-M6YZR3ZW.js";
import {
  invariant
} from "../_browser-chunks/chunk-IWQGIXJS.js";
import "../_browser-chunks/chunk-BMXVGY4U.js";
...
} from "../_browser-chunks/chunk-RDNWKK3U.js";
import {
  combineParameters
} from "../_browser-chunks/chunk-YX25HBUE.js";
import "../_browser-chunks/chunk-7PIQR4A3.js";
...
import { combineTags as combineTags2 } from "storybook/internal/csf";
...
function storyDocsSourceBeforeEach(context) {
  ...
  let service = (() => {
    try {
      return getService("core/story-docs", { internal: !0 });
    } catch {
      return;
    }
  })();
  ...
  let storyId = context.id, componentId = storyId.split("--")[0], cancelled = !1, codePanelSnippetPromise = service.queries.storyDocs.loaded({ id: componentId }).then((payload) => {
    if (cancelled)
      return;
    let snippet = selectSnippetForStory(payload, storyId), source = snippet ?? context.parameters?.docs?.source?.originalSource;
    if (source === void 0)
      return;
    let warning = selectWarningForStory(payload, storyId);
    return emitTransformCode(
      source,
      context,
      snippet === void 0 && warning ? `${warning} Showing the story source instead.` : warning
    );
  });
