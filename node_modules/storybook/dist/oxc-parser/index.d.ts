 ...
 * ```
 */
declare function parseDefaultImports(filePath: string, source: string): Promise<Map<string, string>>;
declare function parseReExports(filePath: string, source: string): Promise<Map<string, ReExportEntry>>;
//#endregion
export { BarrelInfo, type ImportEdge, type ReExportEntry, disposeOxcParsePool, parseBarrelInfo, parseDefaultImports, parseLocalBindings, parseReExports, parseWithOxc };