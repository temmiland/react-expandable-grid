...
} from "../_node-chunks/chunk-6EPLEZFZ.js";
import {
  isTelemetryModuleEnabled,
  telemetry
} from "../_node-chunks/chunk-N4PAIJ2W.js";
import "../_node-chunks/chunk-2BMSH5CU.js";
import {
...
} from "../_node-chunks/chunk-UF3LYQOO.js";
import "../_node-chunks/chunk-VBSZV6KY.js";
import {
  detectAgent
...
import "../_node-chunks/chunk-XSINJFVF.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-2WYCRIJA.js";
import {
  ...
  useStatics,
  writeManifests
} from "../_node-chunks/chunk-5VUZRITZ.js";
import {
  UniversalStore
} from "../_node-chunks/chunk-HFXQZX54.js";
import {
  registerToolset
} from "../_node-chunks/chunk-5ZQGOLDE.js";
import {
  detectPnp
} from "../_node-chunks/chunk-5DGTSUE6.js";
import "../_node-chunks/chunk-4C4AXOGG.js";
import {
  init_build,
  parse
} from "../_node-chunks/chunk-G4ZCAUZF.js";
import "../_node-chunks/chunk-LBGJYL6K.js";
import "../_node-chunks/chunk-XTZ2XLTY.js";
import "../_node-chunks/chunk-ISBS76F6.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-ANRJD6WC.js";
import {
  getErrorLevel,
  sendTelemetryError,
  withTelemetry
...
import "../_node-chunks/chunk-7L4K47Q6.js";
import {
  require_cross_spawn
} from "../_node-chunks/chunk-5XWVTFUD.js";
import {
  up2 as up
} from "../_node-chunks/chunk-7BA6K3X5.js";
import {
  invariant
} from "../_node-chunks/chunk-NQDYICFM.js";
...
import {
  slash
} from "../_node-chunks/chunk-ICU5OS5Q.js";
...
var require_LinkResolver = __commonJS({
  "../../node_modules/watchpack/lib/LinkResolver.js"(exports, module) {
    "use strict";
    var fs = __require("fs"), path = __require("path"), EXPECTED_ERRORS = /* @__PURE__ */ new Set(["EINVAL", "ENOENT"]);
    ...
    var LinkResolver = class {
      ...
      resolve(file) {
        ...
        if (parentResolved[0] !== parent) {
          let basename4 = path.basename(file);
          realFile = path.resolve(parentResolved[0], basename4);
        }
        try {
          let linkContent = fs.readlinkSync(realFile), resolvedLink = path.resolve(parentResolved[0], linkContent), linkResolved = this.resolve(resolvedLink), result;
  ...
  "../../node_modules/graceful-fs/polyfills.js"(exports, module) {
    ...
    function patch(fs) {
      ...
      function patchLutimes(fs2) {
        constants.hasOwnProperty("O_SYMLINK") && fs2.futimes ? (fs2.lutimes = function(path, at2, mt, cb) {
...
GFS4: `), console.error(m);
    ...
    function patch(fs2) {
      ...
      function writeFile5(path, data2, options, cb) {
        return typeof options == "function" && (cb = options, options = null), go$writeFile(path, data2, options, cb);
        function go$writeFile(path2, data3, options2, cb2, startTime) {
          return fs$writeFile(path2, data3, options2, function(err) {
            err && (err.code === "EMFILE" || err.code === "ENFILE") ? enqueue([go$writeFile, [path2, data3, options2, cb2], err, startTime || Date.now(), Date.now()]) : typeof cb2 == "function" && cb2.apply(this, arguments);
          });
        }
      }
      ...
      function appendFile(path, data2, options, cb) {
        return typeof options == "function" && (cb = options, options = null), go$appendFile(path, data2, options, cb);
        function go$appendFile(path2, data3, options2, cb2, startTime) {
          return fs$appendFile(path2, data3, options2, function(err) {
            err && (err.code === "EMFILE" || err.code === "ENFILE") ? enqueue([go$appendFile, [path2, data3, options2, cb2], err, startTime || Date.now(), Date.now()]) : typeof cb2 == "function" && cb2.apply(this, arguments);
          });
        }
      }
  ...
  "../../node_modules/watchpack/lib/reducePlan.js"(exports, module) {
    ...
    module.exports = (plan, limit) => {
      ...
      for (let node2 of treeMap.values()) {
        let parentPath = path.dirname(node2.target);
...
var require_watchEventSource = __commonJS({
  "../../node_modules/watchpack/lib/watchEventSource.js"(exports, module) {
    "use strict";
    var { EventEmitter } = __require("events"), fs = __require("fs"), path = __require("path"), reducePlan = require_reducePlan(), IS_OSX = __require("os").platform() === "darwin", IS_WIN = __require("os").platform() === "win32", SUPPORTS_RECURSIVE_WATCHING = IS_OSX || IS_WIN, watcherLimit = (
    ...
    function createHandleChangeEvent(watcher, filePath, handleChangeEvent) {
      let ownBasename = path.basename(filePath);
      return (type, filename) => {
        if (type === "rename" && path.isAbsolute(filename) && path.basename(filename) === ownBasename) {
    ...
    module.exports.watch = (filePath) => {
      ...
      if (recursiveWatchers.size !== 0) {
        ...
        for (; ; ) {
          ...
          let parent = path.dirname(current2);
  ...
  "../../node_modules/watchpack/lib/DirectoryWatcher.js"(exports, module) {
    ...
    var Watcher = class extends EventEmitter {
      ...
      forEachWatcher(path2, fn) {
        let watchers = this.watchers.get(withoutCase(path2));
        if (watchers !== void 0)
          for (let w of watchers)
            fn(w);
      }
      ...
      onWatchEvent(eventType, filename) {
        ...
        let target = path.join(this.path, filename);
            ...
            let checkStats = () => {
              this.closed || (this._activeEvents.set(filename, !1), lstatWithRetry(target, this, (err, stats) => {
                if (!this.closed) {
                  ...
                  if (this._activeEvents.delete(filename), err && (err.code !== "ENOENT" && err.code !== "EPERM" && err.code !== "EBUSY" ? this.onStatsError(err) : filename === path.basename(this.path) && // This may indicate that the directory itself was removed
              ...
              lstatWithRetry(itemPath, this, (err2, stats) => {
                ...
                if (this.options.followSymlinks && this.nestedWatching && stats.isSymbolicLink()) {
                  fs.realpath(itemPath, (err3, realPath) => {
                    if (this.closed) return;
                    if (err3 || !realPath || withoutCase(path.dirname(realPath)) === withoutCase(this.path)) {
                      apply(null);
                      return;
                    }
                    let rel = path.relative(realPath, itemPath);
      ...
      getTimes() {
        ...
        if (!this.initialScan)
          for (let watchers of this.watchers.values())
            for (let watcher of watchers) {
              let { path: path2 } = watcher;
              Object.prototype.hasOwnProperty.call(obj, path2) || (obj[path2] = null);
            }
        return obj;
      }
      /**
      ...
      collectTimeInfoEntries(fileTimestamps, directoryTimestamps) {
        ...
        if (!this.initialScan)
          for (let watchers of this.watchers.values())
            for (let watcher of watchers) {
              let { path: path2 } = watcher;
              fileTimestamps.has(path2) || fileTimestamps.set(path2, null);
            }
        return safeTime;
      }
      close() {
...
var require_getWatcherManager = __commonJS({
  "../../node_modules/watchpack/lib/getWatcherManager.js"(exports, module) {
    "use strict";
    var path = __require("path"), DirectoryWatcher = require_DirectoryWatcher(), WatcherManager = class {
      /**
       * @param {DirectoryWatcherOptions=} options options
       */
      constructor(options = {}) {
  ...
  "../../node_modules/watchpack/lib/index.js"(exports, module) {
    ...
    var stringToRegexp = (ignored) => {
      ...
      watch(arg1, arg2, arg3) {
        ...
        arg1, this.paused = !1;
        let { fileWatchers, directoryWatchers } = this, { ignored } = this.watcherOptions, filter = (path) => !ignored(path), addToMap = (map, key2, item) => {
...
var require_try_path = __commonJS({
  "../../node_modules/tsconfig-paths/lib/try-path.js"(exports) {
    ...
    var path = __require("path"), path_1 = __require("path"), filesystem_1 = require_filesystem();
...
var require_match_path_sync = __commonJS({
  "../../node_modules/tsconfig-paths/lib/match-path-sync.js"(exports) {
    ...
    var path = __require("path"), Filesystem = require_filesystem(), MappingEntry = require_mapping_entry(), TryPath = require_try_path();
...
var require_match_path_async = __commonJS({
  "../../node_modules/tsconfig-paths/lib/match-path-async.js"(exports) {
    ...
    var path = __require("path"), TryPath = require_try_path(), MappingEntry = require_mapping_entry(), Filesystem = require_filesystem();
...
var require_tsconfig_loader = __commonJS({
  "../../node_modules/tsconfig-paths/lib/tsconfig-loader.js"(exports) {
    ...
    var path = __require("path"), fs = __require("fs"), JSON5 = require_lib(), StripBom = require_strip_bom();
    ...
    function loadTsconfigFromExtends(configFilePath, extendedConfigValue, existsSync4, readFileSync) {
      ...
      var currentDir = path.dirname(configFilePath), extendedConfigPath = path.join(currentDir, extendedConfigValue);
      extendedConfigValue.indexOf("/") !== -1 && extendedConfigValue.indexOf(".") !== -1 && !existsSync4(extendedConfigPath) && (extendedConfigPath = path.join(currentDir, "node_modules", extendedConfigValue));
...
var require_config_loader = __commonJS({
  "../../node_modules/tsconfig-paths/lib/config-loader.js"(exports) {
    ...
    var TsConfigLoader2 = require_tsconfig_loader(), path = __require("path");
...
function resetServicesPresetOnce() {
  globalThis.STORYBOOK_SERVICES_PRESET_PROMISE = void 0;
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-MBJFQ4QO.js");
  ...
  function queueEvent(absolutePath, removed) {
    pendingEvents.set(absolutePath, { removed }), batchTimeout && clearTimeout(batchTimeout), batchTimeout = setTimeout(async () => {
      ...
      pendingEvents.clear(), await Promise.all(
        Array.from(events.entries()).map(([path, { removed: removed2 }]) => onChangeOrRemove(path, removed2))
      );
    }, 100);
  }
...
function registerIndexJsonRoute({
  ...
  watchStorySpecifiers(normalizedStories, { workingDir }, async (path, removed) => {
    (await storyIndexGeneratorPromise).invalidate(path, removed), maybeInvalidate();
...
async function buildStaticStandalone(options) {
  ...
  if (options.outputDir = resolve(options.outputDir), options.configDir = resolve(options.configDir), logger4.step(`Cleaning outputDir: ${import_picocolors3.default.cyan(relative(process.cwd(), options.outputDir))}`), options.outputDir === "/")
  ...
  (hasRegisteredServices || shouldWriteManifests) && effects.push(
    (async () => {
      hasRegisteredServices && (logger4.info("Building open services.."), await writeOpenServiceStaticFiles(options.outputDir)), shouldWriteManifests && await writeManifests(options.outputDir, presets);
    })()
  );
...
import { CLI_COLORS as CLI_COLORS2, deprecate, logger as logger16, prompt } from "storybook/internal/node-logger";
import { MissingBuilderError as MissingBuilderError2, NoStatsForViteDevError } from "storybook/internal/server-errors";
...
import { logger as logger6, pretty } from "storybook/internal/client-logger";
...
// ../../node_modules/polka/node_modules/trouter/index.mjs
var MAP = {
  "": 0,
  GET: 1,
  HEAD: 2,
...
var mount = (fn) => fn instanceof Polka ? fn.attach : fn, Polka = class _Polka extends Trouter {
  constructor(opts = {}) {
    super(), this.parse = parse, this.server = opts.server, this.handler = this.handler.bind(this), this.onError = opts.onError || onError, this.onNoMatch = opts.onNoMatch || this.onError.bind(null, { status: 404 }), this.attach = (req, res) => setImmediate(this.handler, req, res);
  }
  use(base, ...fns) {
  ...
  handler(req, res, next) {
    let info = this.parse(req), path = info.pathname, obj = this.find(req.method, req.path = path);
    if (req.url = path + info.search, req.originalUrl = req.originalUrl || req.url, req.query = info.query || {}, req.search = info.search, req.params = obj.params, path.length > 1 && path.indexOf("%", 1) !== -1)
...
var ChangeDetectionService = class {
  ...
  getModuleGraph() {
    return getService("core/module-graph", { internal: !0 });
  }
  getModuleGraphIndex() {
    return getService("core/module-graph-index", { internal: !0 });
  }
  ...
  onGraphUnavailable(reason, error) {
    this.isActive() && (logger7.warn(`Change detection unavailable: ${reason}`), this.resolveReadiness({ status: "unavailable", reason, error }), this.dispose());
  }
  ...
  start(enabled) {
    if (enabled === !1) {
      logger7.debug("Change detection disabled."), this.resolveReadiness({
        status: "unavailable",
        reason: "disabled"
      });
      return;
    }
    logger7.debug("Change detection enabled."), this.changeDetectionEnabled = !0;
    ...
    if (!(this.disposed || status.value !== "ready")) {
      ...
      try {
        ...
        if (error instanceof ChangeDetectionUnavailableError)
          logger7.warn(`Change detection unavailable: ${error.message}`), this.resolveReadiness({
            status: "unavailable",
            reason: error.message,
            error
          }), await this.dispose();
        else if (error instanceof ChangeDetectionFailureError)
          logger7.error(`Change detection failed: ${error.message}`), this.resolveReadiness({
            status: "error",
            error
          });
        else {
          ...
          logger7.error(`Change detection failed: ${failure.message}`), this.resolveReadiness({
            status: "error",
            error: failure
          });
        }
...
Note: BROWSER environment variable is set to "${browserEnv}". To disable browser opening, use BROWSER=none or the --ci flag.` : "";
      logger9.error(import_ts_dedent.dedent`
...
async function storybookDevServer(options, server) {
  ...
  if (!options.ignorePreview) {
    logger10.debug("Starting preview.."), previewResult = await previewBuilder.start({
      startTime: process.hrtime(),
      options,
      router: app,
      server,
      ...
      throw logger10.error("Failed to build the preview"), process.exitCode = 1, await disposeChangeDetectionRuntime(), await managerBuilder?.bail().catch(() => {
    ...
    try {
      ...
      logger10.warn("Change detection: adapter initialisation failed"), logger10.debug(err instanceof Error ? err.stack ?? err.message : String(err));
    }
...
import {
  Channel as Channel3,
  HEARTBEAT_INTERVAL as HEARTBEAT_INTERVAL2,
  SERVER_CHANNEL_PATH as SERVER_CHANNEL_PATH2,
  setChannel as setChannel2
  ...
  constructor(server, options) {
    ...
    this.socket = new WebSocketServer({ noServer: !0 }), server.on("upgrade", (request, socket, head) => {
      try {
        ...
        if (!url || url.pathname !== SERVER_CHANNEL_PATH2)
          return;
...
`);
        ...
        logger.warn(`Rejecting WebSocket connection: ${error}`), socket.end(`HTTP/1.1 403 Forbidden\r
Connection: close\r
\r
`);
      }
      ...
      wss.on("message", (raw) => {
        let data2 = raw.toString(), event = typeof data2 == "string" && (0, import_telejson2.isJSON)(data2) ? (0, import_telejson2.parse)(data2, {}) : data2;
        this.handler?.(event);
      });
    });
  ...
  close() {
    this.closed || (this.closed = !0, process.removeListener("SIGTERM", this.onSigterm), this.socket.close());
  }
  setHandler(handler) {
    this.handler = handler;
  }
  send(event) {
    let data2 = (0, import_telejson2.stringify)(event, { maxDepth: 15 });
    Array.from(this.socket.clients).filter((c) => c.readyState === WebSocket.OPEN).forEach((client) => client.send(data2));
  }
};
...
function prepareHeadlessUniversalStores() {
  let channel = new Channel3({});
...
import { chmod, mkdir as mkdir2, readFile, readdir, rename, rm as rm2, stat, writeFile as writeFile3 } from "node:fs/promises";
import { homedir, userInfo } from "node:os";
import { findStorybookPackageRoot, normalizeAddonName } from "storybook/internal/common";
var STORYBOOK_MCP_ADDON = "@storybook/addon-mcp", DEFAULT_MCP_ENDPOINT = "/mcp", ONE_DAY_MS = 1440 * 60 * 1e3, SEVEN_DAYS_MS = 7 * ONE_DAY_MS, REGISTRY_DIR_MODE = 448, RECORD_FILE_MODE = 384;
...
async function restrictOwnerAccess(targetPath, mode) {
  if (await chmod(targetPath, mode), process.platform !== "win32")
    return;
...
function getStorybookBaseUrl(address) {
...
function createRuntimeInstanceRecord({
  ...
  let storybookBaseUrl = getStorybookBaseUrl(address), timestamp = now.toISOString();
  return {
    schemaVersion: 1,
    instanceId,
    pid,
...
async function writeRuntimeInstanceRecord(record, registryDir = getDefaultRuntimeInstanceRegistryDir()) {
  await mkdir2(registryDir, { recursive: !0, mode: REGISTRY_DIR_MODE }), await restrictOwnerAccess(registryDir, REGISTRY_DIR_MODE), await cleanupRuntimeInstanceRegistry(registryDir);
  ...
  try {
    await writeFile3(tempPath, `${JSON.stringify(record, null, 2)}
`, {
      encoding: "utf-8",
      mode: RECORD_FILE_MODE
    }), await restrictOwnerAccess(tempPath, RECORD_FILE_MODE), await rename(tempPath, recordPath);
  } catch (error) {
...
async function cleanupRuntimeInstanceRegistry(registryDir) {
  ...
  await Promise.all(
    entries.map(async (entry) => {
      ...
      try {
        let { mtimeMs } = await stat(recordPath);
        ...
        if (!entry.name.endsWith(".json"))
          return;
        let content3 = await readFile(recordPath, "utf-8"), record;
        try {
...
import { SERVER_CHANNEL_PATH as SERVER_CHANNEL_PATH3 } from "storybook/internal/channels";
...
var getServerPort = (port, { exactPort } = {}) => (0, import_detect_port.default)(port).catch((error) => {
  ...
  return exactPort && port != null && freePort !== port && (logger12.error(`Port ${port} is not available. Exiting because --exact-port was provided.`), process.exit(-1)), freePort;
}), getServerChannelUrl = (port, { https: https2 }) => `${https2 ? "wss" : "ws"}://localhost:${port}${SERVER_CHANNEL_PATH3}`, getLocalIp = () => {
...
async function getServer(options) {
  ...
  options.sslCert || (logger13.error("Error: --ssl-cert is required with --https"), process.exit(-1)), options.sslKey || (logger13.error("Error: --ssl-key is required with --https"), process.exit(-1));
  let sslOptions = {
...
var checkPackageCompatibility = async (dependency, context) => {
  ...
  try {
    ...
    return skipErrors || logger14.log(
...
var warnOnIncompatibleAddons = async (currentStorybookVersion, packageManager) => {
  ...
  incompatiblePackagesMessage && logger15.warn(incompatiblePackagesMessage);
};
...
async function buildDevStandalone(options) {
  ...
  try {
    ...
    logger16.warn("Storybook failed to check addon compatibility"), logger16.debug(`${e instanceof Error ? e.stack : String(e)}`);
  }
  try {
  ...
  if (options.host === "0.0.0.0" && (!allowedHosts || allowedHosts !== !0 && allowedHosts.length === 0) && logger16.warn(import_ts_dedent5.dedent`
  ...
  await writeStorybookRuntimeInstanceRecord({
    ...
    logger16.warn("Storybook failed to write its runtime instance registry record."), logger16.debug(error instanceof Error ? error.stack ?? error.message : String(error));
  });
  ...
  if (options.smokeTest) {
    ...
    problems.length > 0 ? (logger16.error("Smoke tests failed."), logger16.log(problems.map((p) => p.stack).join(`
`))) : logger16.step(CLI_COLORS2.success("Smoke tests passed, exiting.")), logger16.outro(""), process.exit(problems.length > 0 ? 1 : 0);
  } else {
...
async function loadStorybook(options) {
  ...
  let channel = options.channel ?? new Channel4({});
  setChannel3(channel);
  ...
  if (builderName) {
    let builderEntry = builderName.startsWith("file:") ? fileURLToPath(builderName) : builderName, builderPresetDir = isAbsolute(builderEntry) ? dirname(builderEntry) : resolvePackageDir(builderEntry), builderPreset = safeResolveModule({ specifier: join(builderPresetDir, "preset.js") });
    builderPreset && corePresets.push(builderPreset);
  }
...
import {
  commonGlobOptions as commonGlobOptions2,
...
import { logger as logger17, once } from "storybook/internal/node-logger";
...
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`, SNIPPET_RENDERED = `${ADDON_ID}/snippet-rendered`;

// src/shared/story-index/sortStories.ts
var import_ts_dedent6 = __toESM(require_dist(), 1);

// src/shared/story-index/storySort.ts
...
function initializeDocument(effects) {
  ...
  function documentContinue(code) {
    if (continued++, self.containerState._closeFlow) {
      ...
      ), self.events.length = index2, checkNewContainers(code);
    }
    return start2(code);
  }
  ...
  function thereIsNoNewContainer(code) {
    return self.parser.lazy[self.now().line] = continued !== stack.length, lineStartOffset = self.now().offset, flowStart(code);
  }
  ...
  function containerContinue(code) {
    return continued++, stack.push([self.currentConstruct, self.containerState]), documentContinued(code);
  }
  ...
  function flowContinue(code) {
    ...
    return markdownLineEnding(code) ? (effects.consume(code), writeToChild(effects.exit("chunkFlow")), continued = 0, self.interrupt = void 0, start2) : (effects.consume(code), flowContinue);
  }
...
function tokenizeCharacterReference(effects, ok2, nok) {
  ...
  function value(code) {
    if (code === 59 && size) {
      ...
      return test === asciiAlphanumeric && !decodeNamedCharacterReference(self.sliceSerialize(token)) ? nok(code) : (effects.enter("characterReferenceMarker"), effects.consume(code), effects.exit("characterReferenceMarker"), effects.exit("characterReference"), ok2);
    }
...
function tokenizeCodeFenced(effects, ok2, nok) {
  ...
  function infoBefore(code) {
    return code === null || markdownLineEnding(code) ? (effects.exit("codeFencedFence"), self.interrupt ? ok2(code) : effects.check(nonLazyContinuation, atNonLazyBreak, after)(code)) : (effects.enter("codeFencedFenceInfo"), effects.enter("chunkString", {
      contentType: "string"
    }), info(code));
  }
  function info(code) {
...
function tokenizeFurtherStart(effects, ok2, nok) {
  ...
  function furtherStart2(code) {
    return self.parser.lazy[self.now().line] ? nok(code) : markdownLineEnding(code) ? (effects.enter("lineEnding"), effects.consume(code), effects.exit("lineEnding"), furtherStart2) : factorySpace(effects, afterPrefix, "linePrefix", 5)(code);
  }
  function afterPrefix(code) {
    let tail = self.events[self.events.length - 1];
...
function tokenizeContinuation(effects, ok2, nok) {
  ...
  function prefixed(code) {
    if (code === null || markdownLineEnding(code))
      return nok(code);
    let tail = self.events[self.events.length - 1];
    return !self.parser.constructs.disable.null.includes("codeIndented") && tail && tail[1].type === "linePrefix" && tail[2].sliceSerialize(tail[1], !0).length >= 4 ? ok2(code) : effects.interrupt(self.parser.constructs.flow, nok, ok2)(code);
  }
}
...
function tokenizeDefinition(effects, ok2, nok) {
  ...
  function afterWhitespace(code) {
    return code === null || markdownLineEnding(code) ? (effects.exit("definition"), self.parser.defined.push(identifier), ok2(code)) : nok(code);
  }
}
...
function tokenizeHtmlFlow(effects, ok2, nok) {
  ...
  function open3(code) {
    return code === 33 ? (effects.consume(code), declarationOpen) : code === 47 ? (effects.consume(code), closingTag = !0, tagCloseStart) : code === 63 ? (effects.consume(code), marker = 3, self.interrupt ? ok2 : continuationDeclarationInside) : asciiAlpha(code) ? (effects.consume(code), buffer = String.fromCharCode(code), tagName) : nok(code);
  }
  function declarationOpen(code) {
    return code === 45 ? (effects.consume(code), marker = 2, commentOpenInside) : code === 91 ? (effects.consume(code), marker = 5, index2 = 0, cdataOpenInside) : asciiAlpha(code) ? (effects.consume(code), marker = 4, self.interrupt ? ok2 : continuationDeclarationInside) : nok(code);
  }
  function commentOpenInside(code) {
    return code === 45 ? (effects.consume(code), self.interrupt ? ok2 : continuationDeclarationInside) : nok(code);
  }
  function cdataOpenInside(code) {
    let value = "CDATA[";
    return code === value.charCodeAt(index2++) ? (effects.consume(code), index2 === value.length ? self.interrupt ? ok2 : continuation : cdataOpenInside) : nok(code);
  }
  ...
  function tagName(code) {
    if (code === null || code === 47 || code === 62 || markdownLineEndingOrSpace(code)) {
      ...
      return !slash2 && !closingTag && htmlRawNames.includes(name2) ? (marker = 1, self.interrupt ? ok2(code) : continuation(code)) : htmlBlockNames.includes(buffer.toLowerCase()) ? (marker = 6, slash2 ? (effects.consume(code), basicSelfClosing) : self.interrupt ? ok2(code) : continuation(code)) : (marker = 7, self.interrupt && !self.parser.lazy[self.now().line] ? nok(code) : closingTag ? completeClosingTagAfter(code) : completeAttributeNameBefore(code));
    }
    return code === 45 || asciiAlphanumeric(code) ? (effects.consume(code), buffer += String.fromCharCode(code), tagName) : nok(code);
  }
  function basicSelfClosing(code) {
    return code === 62 ? (effects.consume(code), self.interrupt ? ok2 : continuation) : nok(code);
  }
...
function tokenizeLabelEnd(effects, ok2, nok) {
  ...
  return start2;
  function start2(code) {
    return labelStart ? labelStart._inactive ? labelEndNok(code) : (defined = self.parser.defined.includes(
      normalizeIdentifier(
        self.sliceSerialize({
...
function tokenizeListStart(effects, ok2, nok) {
  ...
  return start2;
  function start2(code) {
    let kind = self.containerState.type || (code === 42 || code === 43 || code === 45 ? "listUnordered" : "listOrdered");
  ...
  function inside(code) {
    return asciiDigit(code) && ++size < 10 ? (effects.consume(code), inside) : (!self.interrupt || size < 2) && (self.containerState.marker ? code === self.containerState.marker : code === 41 || code === 46) ? (effects.exit("listItemValue"), atMarker(code)) : nok(code);
  }
  function atMarker(code) {
    return effects.enter("listItemMarker"), effects.consume(code), effects.exit("listItemMarker"), self.containerState.marker = self.containerState.marker || code, effects.check(
      blankLine,
  ...
  function onBlank(code) {
    return self.containerState.initialBlankLine = !0, initialSize++, endOfPrefix(code);
  }
  ...
  function endOfPrefix(code) {
    return self.containerState.size = initialSize + self.sliceSerialize(effects.exit("listItemPrefix"), !0).length, ok2(code);
  }
}
function tokenizeListContinuation(effects, ok2, nok) {
  ...
  function notBlank(code) {
    return self.containerState.furtherBlankLines || !markdownSpace(code) ? (self.containerState.furtherBlankLines = void 0, self.containerState.initialBlankLine = void 0, notInCurrentItem(code)) : (self.containerState.furtherBlankLines = void 0, self.containerState.initialBlankLine = void 0, effects.attempt(indentConstruct, ok2, notInCurrentItem)(code));
  }
...
function tokenizeIndent(effects, ok2, nok) {
  ...
  function afterPrefix(code) {
    let tail = self.events[self.events.length - 1];
    return tail && tail[1].type === "listItemIndent" && tail[2].sliceSerialize(tail[1], !0).length === self.containerState.size ? ok2(code) : nok(code);
  }
}
...
function tokenizeSetextUnderline(effects, ok2, nok) {
  ...
  return start2;
  function start2(code) {
    let index2 = self.events.length, paragraph;
    for (; index2--; )
      if (self.events[index2][1].type !== "lineEnding" && self.events[index2][1].type !== "linePrefix" && self.events[index2][1].type !== "content") {
        paragraph = self.events[index2][1].type === "paragraph";
        break;
      }
    return !self.parser.lazy[self.now().line] && (self.interrupt || paragraph) ? (effects.enter("setextHeadingLine"), marker = code, before(code)) : nok(code);
  }
  function before(code) {
...
function initializeFlow(effects) {
  ...
  function atBlankEnding(code) {
    ...
    return effects.enter("lineEndingBlank"), effects.consume(code), effects.exit("lineEndingBlank"), self.currentConstruct = void 0, initial;
  }
  function afterConstruct(code) {
    ...
    return effects.enter("lineEnding"), effects.consume(code), effects.exit("lineEnding"), self.currentConstruct = void 0, initial;
  }
}
...
function initializeFactory(field) {
  ...
  function initializeText(effects) {
    let self = this, constructs2 = this.parser.constructs[field], text3 = effects.attempt(constructs2, start2, notText);
    return start2;
    function start2(code) {
...
function fromMarkdown(value, encoding, options) {
  return typeof encoding != "string" && (options = encoding, encoding = void 0), compiler(options)(
    postprocess(
      parse8(options).document().write(preprocess()(value, encoding, !0))
    )
  );
}
...
var own4 = {}.hasOwnProperty, characters = {}, key;
for (key in characterEntitiesHtml4)
  own4.call(characterEntitiesHtml4, key) && (characters[characterEntitiesHtml4[key]] = key);
...
var own5 = {}.hasOwnProperty, CONTINUE = /* @__PURE__ */ Symbol("continue"), EXIT = /* @__PURE__ */ Symbol("exit"), SKIP = /* @__PURE__ */ Symbol("skip");
...
function factoryMdxExpression(effects, ok2, type, markerType, chunkType, acorn, acornOptions, addResult, spread, allowEmpty, allowLazy) {
  let self = this, eventStart = this.events.length + 3, size = 0, pointStart, lastCrash;
  return start2;
  function start2(code) {
    return effects.enter(type), effects.enter(markerType), effects.consume(code), effects.exit(markerType), pointStart = self.now(), before;
  }
  function before(code) {
    if (code === null) {
    ...
    if (code === 125 && size === 0) {
      let next = acorn ? mdxExpressionParse.call(self, acorn, acornOptions, chunkType, eventStart, pointStart, allowEmpty || !1, spread || !1) : {
        type: "ok",
        estree: void 0
      };
      if (next.type === "ok") {
...
function mdxExpression(options) {
  ...
  function tokenizeTextExpression(effects, ok2) {
    ...
    return start2;
    function start2(code) {
      return factoryMdxExpression.call(self, effects, ok2, "mdxTextExpression", "mdxTextExpressionMarker", "mdxTextExpressionChunk", acorn, acornOptions, addResult, spread, allowEmpty, !0)(code);
    }
  }
}
...
function factoryTag(effects, ok2, nok, acorn, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType) {
  ...
  function attributeBefore(code) {
    ...
    if (code === 62)
      return tagEnd(code);
    if (code === 123)
      return factoryMdxExpression.call(self, effects, attributeExpressionAfter, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, acorn, acornOptions, addResult, !0, !1, allowLazy)(code);
    if (code !== null && code >= 0 && start(code))
  ...
  function attributeValueBefore(code) {
    ...
    if (code === 123)
      return factoryMdxExpression.call(self, effects, attributeValueExpressionAfter, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType, acorn, acornOptions, addResult, !1, !1, allowLazy)(code);
  ...
  function crash(code, at2, expect) {
    let error = new VFileMessage("Unexpected " + (code === null ? "end of file" : "character `" + (code === 96 ? "` ` `" : String.fromCodePoint(code)) + "` (" + serializeCharCode(code) + ")") + " " + at2 + ", expected " + expect, self.now(), "micromark-extension-mdx-jsx:unexpected-" + (code === null ? "eof" : "character"));
...
function mdxjsEsm(options) {
  ...
  function tokenizeExportImport(effects, ok2, nok) {
    ...
    function start2(code) {
      return self.now().column > 1 ? nok(code) : (effects.enter("mdxjsEsm"), effects.enter("mdxjsEsmData"), effects.consume(code), buffer += String.fromCharCode(code), word);
    }
    function word(code) {
...
}), getHeadingText = (node2) => node2.children ? node2.children.map((child) => {
  let c = child;
  return c.type === "text" ? c.value ?? "" : c.children ? getHeadingText(c) : "";
}).join("") : "", getAnchors = (root) => {
  let anchors = [], slugger = new BananaSlug(), walk = (nodes) => {
    for (let node2 of nodes) {
      let n = node2;
      if (n.type === "heading" && typeof n.depth == "number") {
        let title = getHeadingText(n);
        if (title) {
          let id = slugger.slug(title);
          n.depth <= 4 && anchors.push({ id, title });
        }
      }
      n.children && walk(n.children);
    }
  };
  return walk(root.children), anchors;
}, extractImports = (root) => {
  let importMap = {};
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join6(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-MBJFQ4QO.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
    ...
    return files.length === 0 && !ignoreWarnings && once.warn(
      ...
      if (ext === ".storyshot") {
        ...
        logger17.info(`Skipping ${ext} file ${relativePath}`);
        return;
      }
  ...
  async extractStories(specifier, absolutePath, projectTags = []) {
    ...
    tsconfig.resultType === "success" && (matchPath = TsconfigPaths.createMatchPath(
      getTsconfigPathsBaseDir(tsconfig.configFileAbsolutePath),
      tsconfig.paths,
      ["browser", "module", "main"]
    ));
    let toImportPath = (path) => path ? path.startsWith("virtual:") ? path : slash(normalizeStoryPath(relative4(this.options.workingDir, path))) : importPath, storyEntries = indexInputs.map((input) => {
  ...
  async extractDocs(specifier, absolutePath, projectTags = []) {
    ...
    try {
      let normalizedPath = normalizeStoryPath(relativePath), importPath = slash(normalizedPath), content3 = await readFile5(absolutePath, { encoding: "utf8" }), result = await analyzeMdx(content3);
      ...
      throw err && err.source?.match(/mdast-util-mdx-jsx/g) && logger17.warn(
  ...
  async getIndexAndStats() {
    ...
    try {
      ...
      throw this.lastError = err == null || err instanceof Error ? err : void 0, invariant(this.lastError), logger17.warn(`\u{1F6A8} ${this.lastError.toString()}`), this.lastError;
    }
  }
  invalidateAll() {
  ...
  async getPreviewCode() {
    ...
    return previewFile && (await readFile5(previewFile, { encoding: "utf8" })).toString();
  }
...
var buildIndex = async (options) => {
  let { presets } = await loadStorybook(options), [indexers, stories, docsOptions, features] = await Promise.all([
  ...
  logger18.info(`Writing index to ${options.outputFile}`), await writeFile4(options.outputFile, JSON.stringify(index2));
};
...
export {
  ...
  resetServicesPresetOnce as experimental_resetServicesPresetOnce,
