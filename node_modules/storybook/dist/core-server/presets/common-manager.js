...
import {
  ...
  registerService,
  uniq
} from "../../_browser-chunks/chunk-J3E3FSHW.js";
import {
  ...
  TOOL_ID as TOOL_ID2,
  docgenServiceDef
} from "../../_browser-chunks/chunk-B3TL3N57.js";
import {
  EVENTS
...
import {
  ...
  resolveViewport
} from "../../_browser-chunks/chunk-BMXVGY4U.js";
import "../../_browser-chunks/chunk-ZTJL6ODF.js";
import "../../_browser-chunks/chunk-KK3JJ3E4.js";
import "../../_browser-chunks/chunk-QC4HFS6K.js";
import "../../_browser-chunks/chunk-3PFG54GG.js";
import {
  array,
  boolean,
  description,
...
} from "../../_browser-chunks/chunk-YX25HBUE.js";
import {
  cloneDeep,
  pickBy
} from "../../_browser-chunks/chunk-7PIQR4A3.js";
...
import "../../_browser-chunks/chunk-MI5GWNNC.js";
...
// src/shared/open-service/services/review/manager.tsx
import { addons as addons2 } from "storybook/manager-api";

// src/shared/review/features.ts
var isReviewFeatureEnabled = (features) => features?.experimentalReview !== !1 && !!features?.changeDetection;
...
var reviewServiceDef = defineService({
  id: "core/review",
  internal: !0,
...
// src/shared/open-service/services/review/manager.tsx
var ADDON_ID7 = "core/review", manager_default2 = addons2.register(ADDON_ID7, () => {
  isReviewFeatureEnabled(globalThis.FEATURES) && registerService(reviewServiceDef);
});
...
import { addons as addons3, experimental_requestResponse, getService, types } from "storybook/manager-api";
...
var Name = styled15.span({ fontWeight: "bold" }), Required = styled15.span(({ theme: theme3 }) => ({
  ...
  return React20.createElement(StyledTr, null, React20.createElement(StyledTd, { expandable: expandable ?? !1 }, React20.createElement(Name, null, name), required ? React20.createElement(Required, { "aria-hidden": !0, title: "Required" }, "*") : null), compact ? null : React20.createElement("td", null, hasDescription && React20.createElement(Description, { lang: docsLang }, React20.createElement(index_modern_default, null, description2)), table.jsDocTags != null ? React20.createElement(React20.Fragment, null, React20.createElement(TypeWithJsDoc, { hasDescription }, React20.createElement(ArgValue, { value: type, initialExpandedArgs })), React20.createElement(ArgJsDoc, { tags: table.jsDocTags })) : React20.createElement(Type, { hasDescription }, React20.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : React20.createElement("td", null, React20.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? React20.createElement("td", null, React20.createElement(ArgControl, { ...props, isRequired: !!required })) : null);
};
...
var ADDON_ID8 = "addon-controls", PARAM_KEY5 = "controls";
...
function Title() {
  ...
  ).length, suffix = controlsCount === 0 ? null : React27.createElement(Badge, { compact: !0, status: selectedPanel === ADDON_ID8 ? "active" : "neutral" }, controlsCount);
...
// src/controls/manager.tsx
var manager_default3 = addons3.register(ADDON_ID8, (api) => {
  if (globalThis?.FEATURES?.controls) {
    let channel = addons3.getChannel(), docgenService = globalThis.FEATURES?.experimentalDocgenServer ? getService("core/docgen", { internal: !0 }) : void 0, saveStory = async () => {
...
import { addons as addons4, types as types2 } from "storybook/manager-api";
...
// src/actions/manager.tsx
var manager_default4 = addons4.register(ADDON_ID2, (api) => {
  globalThis?.FEATURES?.actions && addons4.add(PANEL_ID, {
    title: Title2,
    type: types2.PANEL,
...
import { Consumer, addons as addons5, types as types3 } from "storybook/manager-api";
...
var ADDON_ID9 = "storybook/interactions", PANEL_ID2 = `${ADDON_ID9}/panel`, PARAM_KEY6 = "interactions", DOCUMENTATION_LINK = "writing-tests/integrations/vitest-addon", DOCUMENTATION_DISCREPANCY_LINK = `${DOCUMENTATION_LINK}#what-happens-when-there-are-different-test-results-in-multiple-environments`, DOCUMENTATION_PLAY_FUNCTION_LINK = "writing-stories/play-function#writing-stories-with-the-play-function", INTERNAL_RENDER_CALL_ID = "internal_render_call";

// ../addons/a11y/src/constants.ts
var ADDON_ID10 = "storybook/a11y", PANEL_ID3 = `${ADDON_ID10}/panel`;
var UI_STATE_ID = `${ADDON_ID10}/ui`, RESULT = `${ADDON_ID10}/result`, REQUEST = `${ADDON_ID10}/request`, RUNNING = `${ADDON_ID10}/running`, ERROR2 = `${ADDON_ID10}/error`, MANUAL = `${ADDON_ID10}/manual`, SELECT = `${ADDON_ID10}/select`, DOCUMENTATION_LINK2 = "writing-tests/accessibility-testing", DOCUMENTATION_DISCREPANCY_LINK2 = `${DOCUMENTATION_LINK2}#why-are-my-tests-failing-in-different-environments`;

// ../addons/vitest/src/constants.ts
var ADDON_ID11 = "storybook/test", TEST_PROVIDER_ID = `${ADDON_ID11}/test-provider`, STORYBOOK_ADDON_TEST_CHANNEL = `${ADDON_ID11}/channel`;
...
var TRIGGER_TEST_RUN_REQUEST = `${ADDON_ID11}/trigger-test-run-request`, TRIGGER_TEST_RUN_RESPONSE = `${ADDON_ID11}/trigger-test-run-response`;
...
var colorsLight = {
  ...
  for (let i2 = maxlength - 1; i2 >= 0; i2 -= 1)
    if (special.test(string2[i2]) && i2 > 10)
      return `${string2.slice(0, i2).replace(trimEnd, "")}\u2026`;
  ...
  let colors = useThemeColors();
  return React46.createElement("span", { style: { whiteSpace: "nowrap", color: colors.instance } }, "Symbol(", description2 && React46.createElement("span", { style: { color: colors.meta } }, '"', description2, '"'), ")");
}, OtherNode = ({ value }) => {
  let colors = useThemeColors();
...
var INITIAL_CONTROL_STATES = {
  ...
  function({ refId, storyId, storyUrl }) {
    ...
    }), state = useStorybookState2(), api = useStorybookApi6(), importPath = api.getData(state.storyId, state.refId)?.importPath, canOpenInEditor = global2.CONFIG_TYPE === "DEVELOPMENT" && !state.refId, [panelState, set] = useAddonState2(ADDON_ID9, {
      status: "rendering",
      controlStates: INITIAL_CONTROL_STATES,
      interactions: [],
      interactionsCount: 0,
...
function PanelTitle() {
  let selectedPanel = useStorybookApi7().getSelectedPanel(), [addonState = {}] = useAddonState3(ADDON_ID9), { status, hasException, interactionsCount } = addonState;
...
// src/component-testing/manager.tsx
var manager_default5 = addons5.register(ADDON_ID9, () => {
...
import { addons as addons6, types as types4 } from "storybook/manager-api";
...
// src/backgrounds/manager.tsx
var manager_default6 = addons6.register(ADDON_ID3, () => {
  globalThis?.FEATURES?.backgrounds && addons6.add(ADDON_ID3, {
    title: "Backgrounds",
    type: types4.TOOL,
...
import { addons as addons7, types as types5 } from "storybook/manager-api";
...
// src/measure/manager.tsx
var manager_default7 = addons7.register(ADDON_ID4, () => {
  globalThis?.FEATURES?.measure && addons7.add(TOOL_ID2, {
    type: types5.TOOL,
    title: "Measure",
...
import { addons as addons8, types as types6 } from "storybook/manager-api";
...
// src/outline/manager.tsx
var manager_default8 = addons8.register(ADDON_ID5, () => {
  globalThis?.FEATURES?.outline && addons8.add(ADDON_ID5, {
    title: "Outline",
    type: types6.TOOL,
    match: ({ viewMode, tabId }) => !!(viewMode && viewMode.match(/^(story|docs)$/)) && !tabId,
...
import { addons as addons9, types as types7 } from "storybook/manager-api";
...
// src/viewport/manager.tsx
var manager_default9 = addons9.register(ADDON_ID, () => {
  globalThis?.FEATURES?.viewport && addons9.add(TOOL_ID, {
